...
function displayConversationsList() {
	var dbResult = db.exec('SELECT Z_PK, ZPARTNERNAME, ZLASTMESSAGEDATE FROM ZWACHATSESSION WHERE ZHIDDEN = 0 AND ZETAG IS NOT NULL ORDER BY ZLASTMESSAGEDATE DESC');
